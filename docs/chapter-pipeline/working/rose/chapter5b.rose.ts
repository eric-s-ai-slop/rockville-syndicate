  ...
  scenes: [
    // ── Scene 0 — The Party ────────────────────────────────────────────────
    {
      ...
      actors: [
        ...
        { id: 'rose',        x: 180, y: 270, nameOverride: 'Rose' },
        { id: 'alex',        x: 430, y: 360, nameOverride: 'Alex' },
        { id: 'nick_f',      x: 460, y: 560 },
        { id: 'benji',       x: 700, y: 340, nameOverride: 'Benji' },
        { id: 'rose_sister', x: 800, y: 200, nameOverride: "Rose's Sister" },
    ...
    // ── Scene 1 — The Lawn ─────────────────────────────────────────────────
    {
      ...
      actors: [
        { id: 'rose',    x: 460, y: 380, nameOverride: 'Rose' },
        { id: 'maharko', x: 410, y: 340 },
        { id: 'nick_f',  x: 560, y: 400 },
        { id: 'jordan',  x: 370, y: 390 },
        { id: 'alex',    x: 600, y: 440, nameOverride: 'Alex' },
      ],
    },
    ...
    // ── Scene 2 — The Car ──────────────────────────────────────────────────
    {
      map: {
        ...
        rects: [
          ...
          { x: 460, y: 50, w: 700, h: 40, fill: C.tv, propType: 'window' },
          // Front-left seat (driver — visual only)
          { x: 330, y: 160, w: 160, h: 90, fill: C.couch, propType: 'car' },
          // Front console
          { x: 460, y: 160, w: 40, h: 90, fill: C.desk, propType: 'car' },
          // Front-right seat (passenger — visual only)
          { x: 590, y: 160, w: 160, h: 90, fill: C.couch, propType: 'car' },
          // Front-back divider (SOLID — blocks forward movement)
          { x: 460, y: 255, w: 760, h: 20, fill: C.desk, propType: 'car', solid: true },
          // Back-left seat (visual only)
          { x: 250, y: 320, w: 200, h: 60, fill: C.couch, propType: 'car' },
          // Back-right seat (visual only)
          { x: 670, y: 320, w: 200, h: 60, fill: C.couch, propType: 'car' },
          // Left door — LOCKED (solid)
          { x: 25, y: 420, w: 20, h: 100, fill: C.door, propType: 'door', solid: true },
          // Right door — LOCKED (solid)
          { x: 895, y: 420, w: 20, h: 100, fill: C.door, propType: 'door', solid: true },
          // Rear window (bottom, dark, not solid)
          { x: 460, y: 610, w: 700, h: 30, fill: C.tv, propType: 'window' },
        ],
        labels: [],
      ...
      actors: [
        ...
        { id: 'rose',    x: 380, y: 360, nameOverride: 'Rose' },
        { id: 'alex',    x: 720, y: 350, nameOverride: 'Alex' },
      ],
    },
  ],
