...
// Hero selection is narrative/cosmetic; gameplay challenge comes from the
// global difficulty setting. Keep one shared baseline for every hero.
const STANDARD_HERO_STATS = {
  role: 'Crew Member',
  difficulty: 'Standard',
  hp: 120,
  maxHp: 120,
...
export const CHARACTER_CLASSES: CharacterClass[] = [
  {
    ...
    relicDesc: 'Administrative proof that no one can gaslight a calculator.',
  ...
  },
  {
    ...
    relicDesc: 'Spare keys for emergencies, international business, and preventable lockouts.',
  ...
  },
  {
    ...
    relicDesc: 'A reminder that plans after 10:30 PM were never real plans.',
  ...
  },
  {
    ...
    relicDesc: '$3,900 in reserves, safely untouched for the foreseeable future.',
